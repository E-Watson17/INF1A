...
stringFSM xs =
  mkFSM [0..n] xs (trans 0 xs) [0] [n]
  where n = length xs
        trans _ "" = []
        trans n (x:xs) = (n,x,n+1) : trans (n+1) xs

emptyFSM :: FSM Int
emptyFSM = mkFSM [0] [] [] [0] [0]
...
simpleFSMbh = mkFSM qs as ts ss fs
 where
   qs = [Q0,Q1,Q2,Q3]
   as = [a,b,c,d]
   ts = [(Q0,a,Q1),(Q0,b,Q3),(Q0,c,Q3),(Q0,d,Q3),(Q1,b,Q1),(Q1,c,Q2),(Q1,d,Q2),(Q1,a,Q3),(Q2,a,Q3),(Q2,b,Q3),(Q2,c,Q3),(Q2,d,Q3),(Q3,a,Q3),(Q3,b,Q3),(Q3,c,Q3),(Q3,d,Q3)]
   ss = [Q0]
   fs = [Q2]
...
muWords = mkFSM [0..8] as
  [(0,b,1),(1,e,6),(0,c,2),(2,a,3),(3,t,4),(0,d,5),(5,o,6),(6,g,4),(5,i,7),(7,c,8),(8,e,4)] [0] [4]
...
eg5i = mkFSM
       [0..5]
       "ab"
       [(0,a,1),(1,b,3),(3,b,4),(4,a,5),(5,a,1),(5,b,3)]
       [0]
       [4]
...
eg5ii = mkFSM
       [0..5]
       "ab"
       [(0,a,1),(1,b,3),(3,b,4),(4,a,5),(1,a,5),(5,b,3)]
       [0]
       [4]
...
eg5iii = mkFSM
       [0..5]
       "ab"
       [(0,a,1),(1,b,3),(3,b,4),(4,a,5),(5,a,1),(5,a,3)]
       [0]
       [1,4]
...
eg5v = mkFSM
       [0..5]
       "ab"
       [(0,a,1),(1,b,3),(3,b,4),(4,a,5),(5,b,1),(5,a,3),(4,b,4)]
       [0]
       [1]
...
eg5vi = mkFSM
       [0..5]
       "ab"
       [(0,b,1),(1,a,3),(3,b,4),(4,a,5),(5,a,1),(4,b,4)]
       [0]
       [1]
...
reverseFSM (FSM qs as ts ss fs) =
  mkFSM qs as (revTrans ts) fs ss where
    revTrans ts = [(q',a,q) | (q,a,q') <- ts ]
